...
CREATE INDEX `storeId_idx` ON `aiInteractions` (`storeId`);
CREATE INDEX `merchantId_idx` ON `aiInteractions` (`merchantId`);
CREATE INDEX `storeId_idx` ON `categories` (`storeId`);
CREATE INDEX `storeId_idx` ON `customers` (`storeId`);
CREATE INDEX `email_idx` ON `customers` (`email`);
CREATE INDEX `storeId_idx` ON `discounts` (`storeId`);
CREATE INDEX `orderId_idx` ON `orderItems` (`orderId`);
CREATE INDEX `storeId_idx` ON `orders` (`storeId`);
CREATE INDEX `customerId_idx` ON `orders` (`customerId`);
CREATE INDEX `productId_idx` ON `productVariants` (`productId`);
CREATE INDEX `storeId_idx` ON `products` (`storeId`);
CREATE INDEX `categoryId_idx` ON `products` (`categoryId`);
CREATE INDEX `storeId_idx` ON `storeThemes` (`storeId`);
